...
const FAQS = [
  ...
  { q: "Where do you operate?", a: "Head office in Hyderabad with branches in Bengaluru and Pune — delivering projects across South India." },
  { q: "Do you handle CEIG approvals and statutory liaisoning?", a: "Yes. We handle all liaisoning works related to Electricity CEIG/Board, from design review through inspection and certification, as part of our end-to-end delivery." },
...
export default function FaqPage() {
  ...
  return (
    <div className="page active">
      ...
      <PageHero
        crumbs="Home · FAQ"
        title={<>Frequently Asked <span className="g">Questions</span></>}
        subtitle="Answers to common questions about our services, process and support."
      />
